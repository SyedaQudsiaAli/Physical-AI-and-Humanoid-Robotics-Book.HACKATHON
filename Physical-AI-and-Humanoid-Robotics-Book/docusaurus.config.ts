...
const config: Config = {
  ...
  tagline: 'Exploring the confluence of machine intelligence and physical form through cutting-edge robotics and hands-on AI experiments.',
  ...
  organizationName: 'SyedaQudsiaAli', // Usually your GitHub org/user name.
  projectName: 'Physical-AI-and-Humanoid-Robotics-Book.HACKATHON', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/SyedaQudsiaAli/Physical-AI-and-Humanoid-Robotics-Book.HACKATHON',
          label: 'GitHub',
          position: 'right',
        },
      ],
